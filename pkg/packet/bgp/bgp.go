...
func (er *EVPNSelectiveMulticastEthernetTagRoute) Len() int {
	//RD(8) + ETAG(4) + MSL(1) + MGL(1) + ORL(1) + MSA(Variable) + MGA(Variable) + ORA(Variable)
	return 15 + int(er.MSL) + int(er.MGL) + int(er.ORL)
}
